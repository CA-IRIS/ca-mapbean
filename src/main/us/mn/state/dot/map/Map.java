...
public final class Map extends JViewport implements LayerListener {
	...
	private static final int ONE_MILE = 3218;//1609;
	private static final int FIVE_MILES = 16090;//8045;
	private static final int TEN_MILES = 32180;//16090;

	/** Map panel */
	private MapPane map = new MapPane(this);

	/** Variable set when map is not visisble */
	/** Needed to get around tabbed panebug */
	...
	public void home(){
		map.setMinimumSize(this.getSize());
	...
	public void mousePressed( MouseEvent e ) {
		...
		public void mouseReleased( MouseEvent e ) {
			...
			if( box ) {
				...
				map.setMinimumSize(new Dimension((int) width, (int) height));
				map.setPreferredSize(new Dimension((int) width, (int) height));
	...
	public void updateLayer(Layer l) {
		if (onTop){ //needed to get around tabbed pane bug.
			map.refreshLayer(l);
		}
	}
